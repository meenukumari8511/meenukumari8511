...
🎯 **My Goal:** To become a job-ready Data Analyst and build practical projects that solve real business problems.
...
* 🚀 Preparing to build and publish my first set of **Data Analytics projects** on GitHub.

---

## 🌱 Currently Learning

* 🗄️ **SQL** — Joins, Subqueries, Views, Stored Procedures, CASE statements
* 📊 **Excel** — Data Cleaning, Formulas, Pivot Tables, Charts & Dashboards
* 🐍 **Python** — Python fundamentals for data analysis
* 🐼 **Pandas & NumPy** — Data manipulation and analysis
* 📈 **Data Visualization** — Matplotlib, Seaborn & Plotly
* 📊 **Power BI** — Data visualization and interactive dashboards
* 📐 **Statistics** — Fundamentals for data analysis and decision-making

> 🚀 Currently focused on turning these skills into practical, real-world Data Analytics projects.
...
<p align="left">
  <a href="https://github.com/meenukumari8511">
